...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar um uzuario que não seja o seu"))
		return
	}
...
// PararDeSeguir usuario permite que um usuario para de seguir o outro
...
// BuscarSeguindo busca todos os usuarios que um está seguindo
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel altera a senha de um usuario que não seja o seu"))
		return
	}
	corpoRequisicao, erro := ioutil.ReadAll(r.Body)
